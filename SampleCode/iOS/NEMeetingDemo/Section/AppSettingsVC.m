...
- (XLFormDescriptor *)setupForm {
  ...
  XLFormRowDescriptor *serverType =
      [XLFormRowDescriptor formRowDescriptorWithTag:@"serverType"
  ...
  for (id key in ServerConfig.servers) {
    [selectorOptions addObject:[XLFormOptionsObject formOptionsObjectWithValue:key
                                                                   displayText:key]];
  }
  serverType.selectorOptions = selectorOptions;
  serverType.value = [XLFormOptionsObject formOptionsOptionForValue:ServerConfig.serverType
                                                        fromOptions:selectorOptions];
  serverType.onChangeBlock = ^(id _Nullable oldValue, id _Nullable newValue,
