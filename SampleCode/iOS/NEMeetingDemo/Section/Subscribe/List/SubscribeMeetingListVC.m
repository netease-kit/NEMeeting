...
@interface SubscribeMeetingListVC () <UITableViewDelegate,
                                      UITableViewDataSource,
                                      NEScheduleMeetingListener>
...
- (void)addObserver {
  [[NSNotificationCenter defaultCenter] addObserver:self
                                           selector:@selector(netStateChange)
                                               name:kReachabilityChangedNotification
                                             object:nil];
}
...
- (void)setupUI {
  ...
  [_listView registerClass:[UITableViewCell class] forCellReuseIdentifier:@"defaultCell"];
...
- (void)groupItems {
  ...
  __weak typeof(self) weakSelf = self;
  [_items enumerateObjectsUsingBlock:^(NEMeetingItem *_Nonnull obj, NSUInteger idx,
                                       BOOL *_Nonnull stop) {
